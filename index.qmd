...
- If you have DataLad installed on your computer, you can run the exercises directly on your computer
- For details about the installation, see [this chapter in the DataLad Handbook](https://mybinder.org/)
:::
::: {.fragment}
- Alternatively, you can run all exercises in a Jupyter Notebook **in your browser without any installation**, using [binder](https://mybinder.org/).
